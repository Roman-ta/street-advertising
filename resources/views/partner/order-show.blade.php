<div class="partner-page">
            ...
            @foreach($materials as $file)
                <div class="materials-list__item">
                    ...
                    <div class="materials-list__info">
                        ...
                        <div class="materials-list__meta">{{ round($file->size_bytes / 1024 / 1024, 2) }} MB</div>
                    </div>
    ...
    @if($item->order->status === 'materials_ready')
        <div class="materials-upload">
            ...
            <p class="materials-upload__hint">
                Сделайте фото установленной рекламы. В момент загрузки запустится таймер аренды.
            </p>

            <label class="spot-form__upload-area" onclick="document.getElementById('report-input').click()">
            ...
            <div wire:loading wire:target="photos" style="text-align:center; padding:12px; color:#5B21B6">
                ⏳ Загружаем...
            </div>
            ...
            >
                ...
                <span wire:loading wire:target="uploadPhotoReport">Загружаем...</span>
            </button>
        </div>
    @endif
    ...
    @if($photoReports->isNotEmpty())
        <div class="materials-list">
            <h3 class="materials-list__title">✅ Фотоотчёты</h3>
            @foreach($photoReports as $file)
                <div class="materials-list__item">
                    <span class="materials-list__icon">📸</span>
                    <div class="materials-list__info">
                        <div class="materials-list__name">{{ basename($file->path) }}</div>
                        <div class="materials-list__meta">{{ $file->created_at->format('d.m.Y H:i') }}</div>
                    </div>
